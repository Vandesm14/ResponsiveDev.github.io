...
<Article title={'Social Links'}>
	<Button href="https://twitch.tv/Responsive" icon="/social/twitch.png" blank>Twitch</Button>
	<Button href="https://twitter.com/Respdev" icon="/social/twitter.png" blank>Twitter</Button>
	<Button href="https://discord.io/Responsive" icon="/social/discord.png" blank>Discord</Button>
	<Button href="mailto:responsivedev@pm.me" icon="/social/email.png" blank>Email</Button>
</Article>